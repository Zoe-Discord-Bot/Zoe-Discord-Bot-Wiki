...
>The next thing you will see is the activation message with a description, a list and buttons. 
<img src="/config_info_4_filtergamecards_activation.png" width="60%" /> <br>
Click on `Make a selection` to pick out of this list, which gamecards should be sent:
<img src="/config_info_4_filtergamecards_menu_choices.png" width="60%" /> <br>
After that click on `Enable the option with these settings`.