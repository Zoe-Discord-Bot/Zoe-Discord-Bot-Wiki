...
Now the role `Zoe-Player` will be created and the channels permissions set so only discord users with the role can see the [infochannel](/en/features/infoChannel).
![config_info_1_hiderole_role.png](/config_info_1_hiderole_role.png)<br>
After that the role is assigned to all [registered/created players](/en/terms/player).
